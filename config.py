...
# --- Целевая группа/канал ---------------------------------------------------
# Куда добавлять пользователей. Можно указать:
#   * @username канала/группы            -> "mygroup"
#   * числовой id супергруппы/канала     -> "-1001234567890"
# Аккаунты ОБЯЗАТЕЛЬНО должны уже состоять в этой группе и иметь право
